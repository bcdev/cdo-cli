...
/**
 * Reader for task XML input streams.
 *
 * @author Ralf Quast
 * @version $Revision: 1.4 $ $Date: 2007-12-13 10:44:18 $
 */
public class XmlTaskInputStreamReader implements TaskInputStreamReader {

    private static XStream xstream;

    public Task read(final InputStream inputStream) throws IOException {
        if (xstream == null) {
            init();
        }
        ...
        if (obj instanceof Task) {
            ...
            throw new IOException("!(object instanceof Task)");
        }
    }
